...
function DashboardDetail(props) {
  const { t } = useTranslation('dashboardDetailPage');
    ...
    <Root
      content={
        <div className="w-full">
          <div className="w-full py-16 px-32 bg-[#F3F9F7] flex flex-col sm:flex-row justify-between">
            <div className="flex items-center w-full sm:w-auto justify-center">
              ...
              <div className="ml-8">
                <div className="flex items-center">
                  ...
                  <EditIconButton aria-label="delete" size="small" className="ml-4">
                    <CreateOutlinedIcon sx={{ fontSize: 14, color: '#D7ECE2' }} />
                  </EditIconButton>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <Typography className="font-HandelGothic font-medium" color="secondary">
                    LOSS
                  </Typography>
                  <Typography className="ml-4 font-medium" color="primary">
                    ID: 004321
                  </Typography>
                </div>
              </div>
          ...
          <div className="w-full container px-32">
