          ...
          <Table className="w-full" sx={{ minWidth: 650 }}>
            ...
            <TableBody>
              {currentData.map((row, index) => (
                <TableRow key={index}>
                  <BodyTableCell
                    className={clsx('pl-8', index === currentData.length - 1 && 'border-none')}
                  >
                    <div className="border-l-2 border-l-[#41D87B] pl-8 py-4">
                      <Typography className="font-bold">{row.symbol}</Typography>
                  ...
                  >
                    <Typography className="font-bold text-[#41D87B]">{row.size}</Typography>
                    <Typography className="text-[#41D87B]">{row.symbol}</Typography>
                  </BodyTableCell>
                  <BodyTableCell
                    align="right"
                    className={clsx(index === currentData.length - 1 && 'border-none')}
                  ...
                  <BodyTableCell
                    ...
                    className={clsx(index === currentData.length - 1 && 'border-none')}
                  >
                    <Typography className="font-bold">{row.margin}</Typography>
                    <Typography className="text-[#41D87B]">{row.status}</Typography>
                  </BodyTableCell>
                  <BodyTableCell
                    align="right"
                    className={clsx('pr-12', index === currentData.length - 1 && 'border-none')}
                  >
                    <Typography className="font-bold text-[#41D87B]">{row.pnl}</Typography>
                    <Typography className="text-[#41D87B]">{row.roi}</Typography>
                  </BodyTableCell>
                </TableRow>
              ))}
            </TableBody>
