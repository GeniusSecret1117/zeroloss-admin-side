...
function SignInPage() {
  ...
  useEffect(() => {
    setValue('email', 'admin@zeroloss.com', { shouldDirty: true, shouldValidate: true });
          ...
          <div className="p-[28px] sm:py-[32px] sm:px-[48px] bg-white rounded-b-xl items-center flex flex-col">
            <div className="flex items-center">
              <Typography component="p" className="text-[24px] font-medium">
                Sign in to&nbsp;
                <span className="font-HandelGothic font-medium text-[#083A3C]">ZERO</span>
                <span className="font-HandelGothic font-medium text-[#41D87B]" color="secondary">
                  LOSS
                </span>
              </Typography>
            </div>
