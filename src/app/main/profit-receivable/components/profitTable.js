  ...
  return (
    <div>
      <div className="rounded-[16px] bg-[#F3F9F7] border border-[#03212352] p-24">
        ...
        <TableContainer className="border border-[#C6D9CD] rounded-[8px] pb-32">
          <Table className="w-full" sx={{ minWidth: 650 }}>
            <TableHead>
              <TableRow>
                ...
                <HeaderTableCell>Customer Details</HeaderTableCell>
                <HeaderTableCell align="right">Profit</HeaderTableCell>
                <HeaderTableCell align="center">ZL %</HeaderTableCell>
                <HeaderTableCell align="center">Payable Amount</HeaderTableCell>
                <HeaderTableCell align="center">Received Amount</HeaderTableCell>
                <HeaderTableCell align="center">Balance Amount</HeaderTableCell>
              ...
              {currentData.map((item, index) => (
                <TableRow key={index}>
                  ...
                  <BodyTableCell
                    align="right"
                  >
                    <Typography className="font-semibold font-Mint">{formatNumber(item.profit)}</Typography>
                  </BodyTableCell>
                  <BodyTableCell
                    align="right"
                  >
                    <Typography className="font-semibold">{item.zl} %</Typography>
                  </BodyTableCell>
                  <BodyTableCell
                    align="right"
                    sx={{
                      backgroundColor: '#D7A9E3',
                    }}
                  >
                  ...
                  >
                    <Typography className="font-semibold font-Mint">{formatNumber(item.received_amount)}</Typography>
                  </BodyTableCell>
                  <BodyTableCell
                    align="right"
                    sx={{
                  ...
                  >
                    <Typography className="font-semibold font-Mint">{formatNumber(item.balance_amount)}</Typography>
                  </BodyTableCell>
                  <BodyTableCell
                    align="center"
                  >
