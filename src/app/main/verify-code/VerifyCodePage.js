...
function VerifyCodePage() {
  ...
  const validateCode = () => {
    const isValid = code.join('') === '123456'; // Example validation logic
    setIsError(!isValid);
  };
      ...
      <CustomPaper className="w-full sm:w-auto min-h-auto rounded-xl bg-transparent mx-8 sm:mx-auto">
        <div className="w-auto sm:w-[480px]">
          ...
          <div className="p-[28px] sm:py-[32px] sm:px-[48px] bg-white rounded-b-xl items-center justify-center flex flex-col">
            ...
            <Typography component="p" className="text-[14px] font-normal mt-[12px]">
            ...
            {isError && (
              <Typography component="p" className="text-[16px] font-medium mb-[12px]" color="primary">
                <span className="text-[#FF143E]">Verification Failed !</span> &nbsp;
                <span>try again</span>
              </Typography>
            )}
            <div className="flex items-center justify-center gap-4">
              <Typography className="text-[16px] font-normal">Didn’t get code?</Typography>
              <Typography className="text-[14px] font-medium underline">Click to resend</Typography>
            </div>
