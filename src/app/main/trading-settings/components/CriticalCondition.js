...
const CriticalCondition = () => {
  ...
  return (
    <div>
      <div className="rounded-[16px] bg-[#FFE6E6] p-16">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <Typography className="font-medium text-[20px]">Critical Condition</Typography>
          <ActiveSwitch
            checked={isChecked}
        ...
        />
        <Typography className="font-medium text-[20px] mt-12">List of Critical Condition Assets</Typography>
        <TableContainer>
