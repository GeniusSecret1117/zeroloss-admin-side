        ...
        <div className="w-auto sm:w-[540px] ">
          ...
          <div className="p-[28px] sm:py-[32px] bg-white rounded-b-xl items-center flex flex-col">
            ...
            >
              ...
              <div className="mb-24">
                ...
                <div className="flex gap-8 items-center">
                  ...
                  <Typography
                    className={clsx('text-[16px] font-medium ', !hasMinLength && 'text-[#FF143E]')}
                  >
                ...
                <div className="flex gap-8 items-center">
                  ...
                  <Typography
                    className={clsx('text-[16px] font-medium ', !hasUpperCase && 'text-[#FF143E]')}
                  >
                ...
                <div className="flex gap-8 items-center">
                  ...
                  <Typography
                    className={clsx('text-[16px] font-medium ', !hasNumber && 'text-[#FF143E]')}
                  >
                    One Number
                  </Typography>
                </div>
                <div className="flex gap-8 items-center">
                  ...
                  <Typography
                    className={clsx('text-[16px] font-medium ', !hasLowerCase && 'text-[#FF143E]')}
                  >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <FormControl>
                      <FormControlLabel
                        label={
                          <Typography component="p" className="text-[14px] font-normal">
            ...
            <div className="flex justify-center mt-24">
              <Link className="text-[16px] font-normal !text-[#032123]" to="/sign-in">
